...
/**
 * Upload documents for project application (user apply flow).
 * Requires JWT. Returns [{ file_id, name }] to include in POST /api/user-project/apply as upload_documents.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${apiUrl}/user-project/upload-application-documents`, {
      method: "POST",
      headers: {

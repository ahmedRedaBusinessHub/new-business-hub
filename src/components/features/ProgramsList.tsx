...
export function ProgramsList() {
    ...
    console.log("🚀 ~ ProgramsList ~ programTypes:", programTypes)
    ...
    const fetchPrograms = async (pageNum: number, isLoadMore: boolean = false) => {
        try {
            if (isLoadMore) {
                setLoadingMore(true);
            } else {
            ...
            const res = await fetch(`/api/public/programs?page=${pageNum}&limit=${limit}`);
